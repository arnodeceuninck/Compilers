...
array_type: '[' max_count=INT_ID ' x ' element_type=normal_type ']' (ptr='*')*;
...
ptr_index: 'getelementptr inbounds' '('? a_type=array_type ',' typed_variable ',' ('i64' | 'i32') INT_ID ',' ('i64' | 'i32') index=value ')'?; // INT_ID is always zero in our generated LLVM code
